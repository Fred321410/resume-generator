...
exports.seed = async function(knex) {
  ...
  await knex('users').insert([
    ...
    {id: 5, username: 'FLORENTIN Matthieu', email: 'matthieu.florentin@gmail.com', birthdate: '1990-08-18', telephone: '0127538163', adresse: '40 boulevard de Sarrebruck', city: 'Nantes'}
  ]);
};
